...
namespace Vikela.Implementation.View
{
    public partial class LoginView : ProjectBaseContentPage<LoginViewController, LoginViewModel>
    {
        ...
        protected override async void OnAppearing()
        {
            ...
            try
            {
                AuthenticationResult ar = await App.PCA.AcquireTokenSilentAsync(App.ApiScopes, GetUserByPolicy(App.PCA.Users, App.PolicySignUpSignIn), App.Authority, false);
                UpdateUserInfo(ar);
        ...
        async void OnEditProfile(object sender, EventArgs e)
        {
            try
            {
                ...
                AuthenticationResult ar = await App.PCA.AcquireTokenAsync(App.ApiScopes, GetUserByPolicy(App.PCA.Users, App.PolicyEditProfile), UIBehavior.SelectAccount, string.Empty, null, App.AuthorityEditProfile, App.UiParent);
                UpdateUserInfo(ar);
            }
            catch (Exception ex)
            {
        ...
        async void OnPasswordReset()
        {
            try
            {
                AuthenticationResult ar = await App.PCA.AcquireTokenAsync(App.ApiScopes, (IUser)null, UIBehavior.SelectAccount, string.Empty, null, App.AuthorityResetPassword, App.UiParent);
                UpdateUserInfo(ar);
            }
            catch (Exception ex)
            {
