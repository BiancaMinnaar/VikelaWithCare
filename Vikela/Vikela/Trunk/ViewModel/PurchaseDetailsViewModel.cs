...
namespace Vikela.Implementation.ViewModel
{
    public class PurchaseDetailsViewModel : ProjectBaseViewModel
    {
        ...
        public Guid BeneficiaryID { get => _beneficiaryID; set { _beneficiaryID = value; OnPropertyChanged("BeneficiaryID"); } }
        public Guid PolicyID { get => _policyID; set { _policyID = value; OnPropertyChanged("PolicyID"); } }
    }
}